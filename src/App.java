...
public class App {
    ...
    public String getUserName () {
        ...
        // I added the final blank line so that there would be space between the "HI!" banner and the question asking you to enter your name
    ...
    public void doMadlib() {
        ...
        // input.nextInt considers Enter to be a character and it would result in an empty string.

        if (storyChosen == 1) {
// I used two = signs because when only one sign is used its asking the code if a statement is true, two signs means youre making two variables equal eachother
            ...
            System.out.println("Once, there was a group of " + numberOne + " teens, and they were so " + adjectiveOne + ". One of them was named " + boyNameOne + ", he liked to eat " + foodOne + ". One " + adjectiveTwo + " morning, the " + numberOne + " teens decided to go explore a haunted " + nounOne + ". But, there night was cut short when they were attacked by a/an " + adjectiveThree + " dead " + animalOne + ". They " + pastTenseVerbOne + " and got away from the ghost. " + boyNameOne + " then went to his " + adjectiveFour + " house and enjoyed a plate of " + foodOne + ".");
            ...
            System.out.println ("One " + adjectiveOne + " night I was " + verbOne + " by my " + nounOne + " when I heard a " + adjectiveTwo + " sound coming from my backyard. I " + verbTwo + " into my backyard and saw a group of " + numberOne + " aliens. They were " + adjectiveThree + " " + adjectiveFour + " and " + colorOne + ". They came into my house and one of them tried to " + verbThree + " on my table but it slipped on some " + foodOne + " their leader spoke 'Share all of humanities secrets with us or else " + threatOne + "''.");
            ...
            System.out.println ("I was in " + placeOne + " when suddenly I ran into a " + adjectiveOne + " witch. I tried to run away but she grabbed my " + bodyPartOne + ", I pushed her off but tripped on a " + objectOne + ". She " + verbOne + " and let out a " + adjectiveTwo + " laugh. She got a " + colorOne + " wand out of her pocket and said '" + gibberishOne + "'. Suddenly I was transformed into a " + adjectiveThree + " " + nounOne + ", then she got a " + objectTwo + " out of her bag and took a bite out of it. I was so" + emotionOne + "." );

        } else {
            System.out.println("You didn't choose a value between 1 - 3, so you can't play >:))");
// I need to do this because the code needs to know what to do inc case a value between 1-3 isnt chosen
